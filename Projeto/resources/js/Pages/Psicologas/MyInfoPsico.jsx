...
const MyInfoPsico = () => {
    const { props } = usePage();
    const { psicologa, flash } = props;

    const [formData, setFormData] = useState({
        nome: psicologa.nome || '',
        phone_number: psicologa.phone_number || '',
        rua: psicologa.rua || '',
        cep: psicologa.cep || '',
        bairro: psicologa.bairro || '',
        localidade: psicologa.localidade || '',
        uf: psicologa.uf || '',
        especializacao: psicologa.especializacao || '',
        horario_disponivel: psicologa.horario_disponivel || '',
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        Inertia.post(route('psico.myinfo.update'), formData);
    };
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value={formData.horario_disponivel}
                            onChange={handleChange}
                            className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        />
                    </div>
